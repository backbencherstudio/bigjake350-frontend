...
export default function Header() {
  return (
    <div className="bg-gradient-to-b from-white via-[#3e813e] to-white flex flex-col md:flex-row items-center md:justify-between border-b-2 border-gray-300 px-4 py-6 space-y-4 md:space-y-0">
